  ...
  <q-layout view="lHh Lpr lff">
    ...
    >
      <q-scroll-area style="height: calc(100% - 150px); margin-top: 150px; border-right: 1px solid #ddd">
        <q-list padding>
          <q-item clickable v-ripple :active="activeLink === 'user-cats'" @click="goToLink('user-cats')">
          ...
          <q-item clickable v-ripple :active="activeLink === 'user-account'" @click="goToLink('user-account')">
            <q-item-section avatar>
